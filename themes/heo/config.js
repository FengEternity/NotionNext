const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-05-14', // 建站日期，用于计算网站运行的第几天
  ...
  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '光与影', url: 'https://www.montylee.cc/image?theme=heo' },
  HERO_CATEGORY_2: { title: '二次元', url: 'https://www.montylee.cc/category/二次元?theme=heo' },
  HERO_CATEGORY_3: { title: ' M&D', url: 'https://www.montylee.cc/category/深度学习?theme=heo' },
